...
- If a directory listed Stripe first, read [why Stripe is not a RevenueCat alternative on iOS](/guides/why-stripe-is-not-a-revenuecat-alternative-ios).`,
          author: "IndieAppStack",
          status: "published",
          content_type: "comparison",
          primary_category_id: categories.get("monetization").id,
...
Last checked: Aug 11, 2026.`,
          ...
          seo_title: "Sentry vs Firebase Crashlytics: 2026 Pricing",
          seo_description:
...
- Pair this with the [subscription MVP stack guide](/guides/subscription-mvp-stack-solo-ios-app) if the launch depends on paid subscriptions.`,
        ...
        {
          title: "Why Stripe is not a RevenueCat alternative on iOS",
          ...
          excerpt:
            "Can you use Stripe instead of RevenueCat on iOS? For in-app digital goods, no. Apple requires In-App Purchase; Stripe fits physical goods, web checkout, and Mac apps outside the store.",
          body_markdown: `## Short answer
...
`,
          ...
          content_type: "guide",
          primary_category_id: categories.get("monetization").id,
          seo_title: "Can I use Stripe instead of RevenueCat on iOS?",
          seo_description:
            "No. In-app digital subscriptions on iOS require Apple In-App Purchase. Stripe fits physical goods, web checkout, and Mac apps outside the store.",
          human_reviewed: true,
          ai_assisted: true,
          published_at: stripeGuidePublishedAt,
        },
        {
          title:
          ...
          subtitle:
            "EU terms take effect Oct 1, 2026. The Small Business Program In-App Purchase rate is 15 percent of the price the customer pays.",
          excerpt:
            "At $1,000, $5,000, and $10,000 a month, a Small Business Program developer on EU In-App Purchase pays Apple $150, $750, and $1,500. The initial acquisition fee and store services fee are eliminated.",
          body_markdown: `## Short answer
...
- Review the [monetization category](/categories/monetization).`,
          ...
          content_type: "guide",
          primary_category_id: categories.get("monetization").id,
          seo_title: "App Store new business terms 2026 cost",
          seo_description:
            "EU App Store terms take effect Oct 1, 2026. Commission at $1,000, $5,000, and $10,000 a month, from Apple's published rates.",
          human_reviewed: true,
          ai_assisted: true,
  ...
  await upsert(
    ...
    [
      ...
      {
        article_id: articles.get(
          "why-stripe-is-not-a-revenuecat-alternative-ios",
        ).id,
        tool_id: tools.get("revenuecat").id,
        relationship: "featured",
        sort_order: 10,
